...
- (id)initInScrollView:(UIScrollView *)scrollView activityIndicatorView:(UIView *)activity
{
    ...
    if (self) {
        ...
        self.originalContentInset = UIEdgeInsetsMake(scrollView.contentInset.top + 64, scrollView.contentInset.left, scrollView.contentInset.bottom, scrollView.contentInset.right);
